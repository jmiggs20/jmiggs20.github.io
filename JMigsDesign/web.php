...
<html>
	<head>
		...
		<title>JMIGSDESIGN | The Creative Portfolio of Jeremy Miragliotta</title>
		<meta name="description" content="">
		<meta property="og:title" content="JMIGSDESIGN | Web Work">
		<meta property="og:type" content="page">
		<meta property="og:url" content="jmigsdesign.com/web.php">
		<meta property="og:image" content="images/shared_logo.png">
		<meta property="og:description" content="These are websites created by Jeremy.">
			...
			<div class="col-sm-6 feature">
					<div class="panel">
						<div class="panel-heading">
							<h3 class="panel-title">Garden State Races</h3>
						</div><!-- end panel-heading -->
						<div class="web-thumbnail">
						<img src="images/web_gsr.jpg" alt="GardenStateRaces.com Logo">
						</div>
						<a href="http://www.gardenstateraces.com" target="_blank" class="btn btn-feature btn-block">View Site</a>						
						</div><!-- end panel -->
				</div><!-- end feature -->
				...
				<div class="col-sm-6 feature">
					<div class="panel">
						...
						<div class="web-thumbnail">						
							<img src="images/web_live2bfit.jpg" alt="Live2BFit Logo">
						</div>
						<button class="btn btn-feature btn-block">Coming Soon!</button>					
						</div><!-- end panel -->
				</div><!-- end feature -->
